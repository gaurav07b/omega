...
//=======================================================ASSEMBLER=========================================================
	private List<EmployeesDto> empAssembler(List<Employees> userList) {
		...
		userList.forEach( emp -> {
			...
			//empDto.setJobType(emp.getJobType());
...
//=====================================================GET ONE EMPLOYEE=======================================================
		@Override
		public EmployeesDto findOneEmp(int emp_id) {
			Employees empl = empRepository.getOne(emp_id);
			EmployeesDto empDto = new EmployeesDto();
			...
			//empDto.setJobType(empl.getJobType());
...
//============================================UPDATE EMPLOYEES(id in payload)=================================================
		...
		public EmployeesDto updateEmp(EmployeesDto empDto) {
			...
			//List<Project> projSet = convertToEntProj(empDto.getProjects());
			//emp.setProjects(projSet);
			//Salary sdto = converToEntSal(empDto.getSalary());
			//emp.setSalary(sdto);
...
//========================================================DELETE ONE==========================================================
	@Override
	public String deleteOneEmp(int emp_id) {
		Employees empl = empRepository.getOne(emp_id);
...
//=======================================Conversions DTO to Entity and vice-versa==========================================
	...
	private Departments convertToEntDept(DepartmentsDto ddto) {
		...
		//department.setDeptName(ddto.getDeptName());
		//department.setLocation(ddto.getLocation());
		return department;
}
	...
	private Salary converToEntSal(SalaryDto salDto) {
		...
		//sal.setSal(salDto.getSal());
		//sal.setDate(salDto.getDate());
		return sal;
}
	...
	private List<Project> convertToEntProj(List<ProjectDto> projects) {
		...
		projects.forEach(project->{
			...
			//pNew.setpName(project.getpName());
			//pNew.setpLocation(project.getpLocation());
			proj.add(pNew);
		});
		return proj;
	}
