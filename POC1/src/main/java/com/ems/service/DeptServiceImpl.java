...
//=======================================================DELETE============================================================
	...
	@Override
	public String deleteOneDept(int dept_id) {
		Departments dept = deptRepo.getOne(dept_id);
...
//===================================================FIND ONE DEPARTMENT===================================================
	...
	@Override
	public DepartmentsDto findOneDept(int dept_id) {
		Departments dept = deptRepo.getOne(dept_id);
...
//=======================================ADD NEW DEPARTMENT==============================================================
	...
	public DepartmentsDto addNewDept(DepartmentsDto newDto) {
		...
		//dept.setDeptId(newDto.getDeptId());
